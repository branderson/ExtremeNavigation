...
namespace Utility
{
	...
	public class EventManager : Singleton<EventManager>
    {
	    ...
	    private Dictionary<string, Events.LongEvent> _eventsLong;
	    ...
	    public void Initialize()
	    {
	        if (_eventsLong == null)
	        {
	            _eventsLong = new Dictionary<string, Events.LongEvent>();
	        }
	        if (_eventsVoid == null)
	        {
	    ...
	    {
	        Events.LongEvent thisEvent = null;
            ...
            {
                thisEvent = new Events.LongEvent();
                thisEvent.AddListener(listener);
